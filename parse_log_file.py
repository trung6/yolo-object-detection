...
def parse_args():
    ...
    # parser.add_argument('--source-dir', dest='source_dir', required=False,type=str, default='/content/gdrive/My Drive/darknet',
    #                     help='the log source directory')
    parser.add_argument('--source-dir', dest='source_dir', required=False,type=str, default='/content/gdrive/My Drive/darknet',
                        help='the log source directory')
    parser.add_argument('--save-dir', dest='save_dir', required=False,type=str, default='/content/gdrive/My Drive/darknet',
                        help='the directory to be saved')
    parser.add_argument('--csv-file', dest='csv_file', required=False,type=str, default="log.csv",
                        help='training log file')
    parser.add_argument('--log-file', dest='log_file', required=False,type=str, default="log.txt",
                        help='training log file')
    parser.add_argument('--show', dest='show_plot', required=False,type=bool, default=True,
